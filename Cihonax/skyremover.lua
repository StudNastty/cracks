...
a.Name = "removeanticheatinvisibleshitandkillparts"
...
e.Text = "Remove Anti Cheat and Invisible Shits?"
    ...
    function()
        ...
        game.RunService.Stepped:Connect(
            function()
                pcall(
                    function()
                        for l, m in pairs(game.StarterGui:GetDescendants()) do
                            if m.Name == "Extra" then
                                m:Destroy()
                            end
                        end
                        for l, m in pairs(game.Players.LocalPlayer.PlayerGui:GetDescendants()) do
                            if m.Name == "Extra" then
                                m:Destroy()
                            end
                        end
        ...
        for l, m in pairs(game.Workspace.Borders:GetDescendants()) do
            if m.Name == "InvisibleBorder" then
                m:Destroy()
            end
        end
        for l, m in pairs(game.Workspace.Lobby:GetDescendants()) do
            if m.Name == "KillPlates" then
                m:Destroy()
            end
        end
        for l, m in pairs(game.Workspace:GetDescendants()) do
            if m.Name == "GroupDoor" then
                m:Destroy()
            end
        end
        loadstring(
